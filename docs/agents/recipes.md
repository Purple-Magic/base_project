...
- For copy or duplicate flows, open [docs/agents/recipes/copy-feature.md](/home/pavel/projects/base_project/docs/agents/recipes/copy-feature.md).
...
- If no recipe exists yet, add a new focused file in `docs/agents/recipes/` and link it here.
